              ...
              <div className="max-w-3xl">
                ...
                <div className="mt-6 space-y-4 text-base leading-7 text-muted-foreground sm:text-lg sm:leading-8">
                  <p>
                    ...
                    interface has to stay clear even when the workflows,
                    backend dependencies, and user states get complex.
                  </p>
                  <p>
                    My strongest work today is frontend-led, but the way I
                    build already leans into backend-aware thinking: API
                    contracts, validation, state boundaries, resilience, and
                    systems that can keep growing well.
                  </p>
                </div>
        ...
        <PageContainer>
          <div className="grid gap-5 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)]">
            ...
            <Reveal delay={0.08} distance={16}>
              <Card className="h-full rounded-[1.6rem] border border-border/70 bg-card/75 shadow-sm">
                <CardHeader>
                  <CardTitle className="text-2xl">Recent timeline</CardTitle>
                </CardHeader>
