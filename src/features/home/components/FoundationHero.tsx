    ...
    <Section className="relative flex min-h-[calc(100svh-4rem)] items-center overflow-hidden">
      ...
      <PageContainer>
        <div className="max-w-5xl">
          ...
          <p className="mb-4 font-mono text-xs uppercase tracking-[0.2em] text-muted-foreground sm:text-sm font-medium">
            Frontend-heavy full-stack developer
          </p>
          <h1 className="max-w-5xl font-heading text-5xl leading-[1.1] font-semibold tracking-[0.015em] text-balance sm:text-6xl md:text-7xl lg:text-8xl">
